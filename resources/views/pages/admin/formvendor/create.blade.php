...
<div class="page-content"> 
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('formvendor.store') }}" method="POST" class="space-y-8">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="kategori_bisnis" id="kategori_bisnis" class="mt-1 block w-full border rounded p-2 form-control">
                            </div>
                            <div class="mb-3">
